...
- [x] **Phase 2: UI Shell + Per-Turn Play** - Streamlit setup/rules/play screens; a human can play all 36 weeks against three AI opponents (completed 2026-05-18)
- [x] **Phase 3: Debrief Charts + Narrative** - 4-panel chart, amplification ratio, cost breakdown, and ≤200-word per-station narrative (completed 2026-05-18)
- [x] **Phase 4: Deploy to Streamlit Community Cloud** - Public URL on Streamlit Community Cloud from `greycloak85/beer-game` with pinned Python 3.12 (completed 2026-05-18)
...
| 4. Deploy to Streamlit Community Cloud | 0/2 | Complete    | 2026-05-18 |
